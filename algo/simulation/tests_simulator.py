...
def debug_trades(params: SimDebugParameter, num_iter=4):
...
class TestSimulator(unittest.TestCase):
    ...
    def test_price_invariance(self):
        ...
        def assert_trades_equal(param0: SimDebugParameter, param1: SimDebugParameter, min_num_trades, num_iter=4):
            trades = [debug_trades(param, num_iter) for param in (param0, param1)]
        ...
        assert_trades_equal(SimDebugParameter(1.4, 5 * 60, 0.0, 0.01), SimDebugParameter(57, 5 * 60, 0.0, 0.01), 1, 3)

        negate_assert(lambda: assert_trades_equal(SimDebugParameter(1.4, 5 * 60, 0.0, 0.01),
                                                  SimDebugParameter(57, 5 * 60, 0.0, 0.011), 1, 3))

        assert_trades_equal(SimDebugParameter(1.4, 5 * 60, 0.0, 0.01, True),
                            SimDebugParameter(57, 5 * 60, 0.0, 0.01, True),
                            2,
                            4)
